...
01. **String searching algorithms**: algorithms for finding a pattern in a string, such as the `Knuth-Morris-Pratt (KMP) algorithm` and the `Boyer-Moore algorithm`.
